...
class EstateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.estates.index', compact('estates', 'pagination'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.estates.create', compact('zones', 'types', 'agents', 'owners', 'services'));
    }
    ...
    public function show(string $estateCode)
    {
        ...
        return view('admin.estates.show', compact('estate','owner', 'zone', 'agents', 'services'));
    }
    ...
    public function edit(string $estateCode)
    {
        ...
        return view('admin.estates.edit', compact('estate', 'zones', 'types', 'agents', 'owners', 'services'));
    }
